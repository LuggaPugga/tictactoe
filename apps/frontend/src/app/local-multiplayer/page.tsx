...
export default function LocalMultiplayer() {
  ...
  const [globalBoard, setGlobalBoard] = useState<LocalBoard>(Array(9).fill(null))
  ...
  }, [players, currentPlayerIndex, game, globalBoard, currentBoard, scores, isGameStarted])
    ...
    (boardIndex: number, cellIndex: number) => {
      ...
      if (
        ...
        (currentBoard === null ||
          ...
          (currentBoard !== null && game[currentBoard]?.every((cell) => cell !== null)))
      ) {
        ...
        if (localWinner) {
          newGlobalBoard[boardIndex] = localWinner === "tie" ? null : localWinner
        }
        ...
        if (globalWinner) {
          ...
          const isBoardFull = nextBoardCells?.every((cell) => cell !== null) || false
