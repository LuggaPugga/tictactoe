...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const eventHandlers = {
      ...
      lobbyCreated: ({ roomCode, sessionCode }: { roomCode: string; sessionCode: string }) => {
        ...
        <div className="w-full max-w-lg space-y-8">
          ...
          <Card className="border-none shadow-none">
            <CardHeader>
              ...
              <CardDescription>Choose how you want to play TicTacToe</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="grid gap-4">
                      <Button
                        onClick={() => (inQueue ? handleLeaveQueue() : handleQueueJoin())}
